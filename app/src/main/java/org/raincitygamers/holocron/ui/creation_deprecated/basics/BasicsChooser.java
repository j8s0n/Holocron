package org.raincitygamers.holocron.ui.creation_deprecated.basics;
...
import org.raincitygamers.holocron.ui.creation_deprecated.characteristics.CharacteristicsChooser;
...
public class BasicsChooser extends ChooserBase {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    getSupportActionBar().setTitle("Choose Basics");
    setContentView(R.layout.choose_basics);
    buildCareerSpinner();
  }
  ...
  public void onDoneClicked(View view) {
    ...
    Intent intent = new Intent(this, CharacteristicsChooser.class);
